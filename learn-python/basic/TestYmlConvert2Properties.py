...
if __name__ == "__main__":
    # print(sys.argv)
    ymlFile = "/Users/huangqihang/workspace/ads/source/bi-marketing-platform-biz/bi-marketing-platform-biz-impl/src/main/resources"
    ymlFile += "/application-release-jkt.yml"
    # sys.argv.ymlFile
    sys.argv.append(ymlFile)
    args = parse_arguments(sys.argv)
    yml_to_properties(args)
